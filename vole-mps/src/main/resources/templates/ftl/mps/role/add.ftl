...
<@body>
<form class="form-horizontal layui-form layui-form-pane" method="post" action="/mps/role/doAdd">
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-10">
              <input type="text" id="ucode" name="roleCode" class="form-control" placeholder="请输入角色编码"  lay-verify="required">
          </div>
      </div>
    <div class="form-group">
